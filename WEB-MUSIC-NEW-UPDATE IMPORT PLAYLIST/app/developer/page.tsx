  ...
  return (
    <main className="min-h-screen pb-24">
      ...
      <div className="px-6 pt-6">
        <h2 className="text-[#4ADE80] text-sm font-medium mb-8">
          Lead Developer
        </h2>
        ...
        >
          ...
          <div className="flex items-center justify-center gap-2 mb-2">
            <h2 className="text-2xl font-bold text-white">Shann</h2>
          ...
          <p className="text-white/60 text-sm leading-relaxed max-w-sm mb-6">
            ...
            hari dengan kualitas audio premium tanpa batasan.
          </p>
          ...
          <div className="grid grid-cols-4 gap-3 w-full max-w-sm mb-4">
            ...
            <a
              href="https://whatsapp.com/channel/0029VbCcsJPDeONDOik3sk3H"
              target="_blank"
            ...
            <a
              href="https://www.instagram.com/shan_b4nh?igsh=MW5mNGQycXIya2w4Ng=="
              className="flex flex-col items-center justify-center gap-2 bg-[#1C1C1E] hover:bg-[#2C2C2E] p-4 rounded-2xl transition-colors"
            >
